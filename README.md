...
•	Bán hàng phải có giỏ hàng: (tham khảo các web bán hàng online) 
    ...
    o	Thêm xóa sửa sản phẩm trong giỏ hàng

    o	Yêu cầu phải đăng nhập

    o	Cho phép chọn hình thức chi trả (Online hoặc COD) 

    o	Cho phép chọn hoặc nhập địa chỉ mới. 

Các chức năng cho người quản trị web (web-admin)

•	Quản lý user (thêm#đăng ký, sửa, khoá/ mở user) - giao diện cho người quản trị web.
...
•	Xoá sản phẩm: kiểm tra nếu sản phẩm đã được bán ra thì ẩn sản phẩm hiển thị trên web, nếu sản phẩm chưa được bán ra thì hỏi lại và tiến hành xoá sản phẩm đó.

•	Quản lý hoá đơn : - quản lý tình trạng đơn hàng.

•	Quản lý hoá đơn : - lọc đơn hàng theo khoảng thời gian giao hàng (từ ngày đến ngày).
